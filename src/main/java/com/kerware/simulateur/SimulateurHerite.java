...
public class SimulateurHerite {
    ...
    private int rNet = 0; //revenus net PS
    private int nbEnf = 0; //nombre d'enfants à charge
    private int nbEnfH = 0; //nombre d'enfants en situtaion de handicap
	...
	/**
	 * Calculer l'impôt à partir du revenus net
	 * @author picots
	 */
